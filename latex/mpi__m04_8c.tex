...
Laboratorio M4\-: Recogida global en M\-P\-I (I\-I\-I) -\/ Concatenación.  
...
Laboratorio M4\-: Recogida global en M\-P\-I (I\-I\-I) -\/ Concatenación. \subsection*{Recogida global en M\-P\-I (I\-I\-I)}
...
$p_{destino} = (i + 1) \mod n$ , siendo {\itshape i} el número del proceso actual, y {\itshape n} el número de procesos.
\end{DoxyItemize}
...
$s_{recepción} = (i - e - 1) \mod n$ , siendo {\itshape i} el número del proceso actual, {\itshape e} la etapa actual y {\itshape n} el número de procesos.
\end{DoxyItemize}
...
Estado de envíos M\-P\-I global para ser usado desde métodos de envío y recepción. \hypertarget{mpi__m04_8c_ae086787f574c1a13b95728ca3cddbc08}{\index{mpi\-\_\-m04.\-c@{mpi\-\_\-m04.\-c}!vector@{vector}}
